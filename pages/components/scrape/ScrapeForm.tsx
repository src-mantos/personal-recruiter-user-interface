...
const ScrapeForm = (props:ScrapeFormProps)=>{
        ...
        <div className={['tile is-ancestor', styles["form-wrapper"] ].join(" ")}>
            ...
            <div className={['tile is-parent is-vertical',styles['no-flex-grow']].join(" ")} >
                <div className={['is-child control'].join(" ")} >
                    <input ref={requestPageDepth} placeholder='Page Depth' className={["input", styles["btn-width"] ].join(" ")} type="number" style={{padding:"0 0 0 10px" }}/>
                </div>
                <div className={['is-child control'].join(" ")} >
